...
class ApisControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create api' do
    assert_difference('Api.count') do
      post apis_url, params: { api: { hash_i: @api.hash_i, host: @api.host, listing: @api.listing, location: @api.location, path: @api.path } }
    end
  ...
  test 'should update api' do
    patch api_url(@api), params: { api: { hash_i: @api.hash_i, host: @api.host, listing: @api.listing, location: @api.location, path: @api.path } }
